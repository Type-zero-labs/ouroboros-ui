...
- **Zoom range.** Canvas Scene `zoom_range` is `MIN_ZOOM = 0.2` .. `MAX_ZOOM = 4.0` (private consts). This is the **live** range — note it is *not* the [`Viewport`](./viewport.md) helper's `0.25..2.5`; the canvas does not use `Viewport`.
